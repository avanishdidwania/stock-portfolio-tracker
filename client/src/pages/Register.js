...
import './Login.css'; // Using the exact same CSS structure as Login
import { Mail, Lock, User, TrendingUp, BarChart2, ShieldCheck, IndianRupee } from 'lucide-react';
...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('Invalid details or email already exists');
        }
    };
            ...
            <div className="login-left">
                <div className="login-content-wrapper">
                    ...
                    <div className="login-header">
                        ...
                        <p>Join to start tracking your portfolio</p>
                    </div>
                    ...
                    <form className="login-form" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="login-button" style={{ marginTop: '1.5rem' }}>Create account</button>
                    ...
                    <div className="login-footer">
                        <span>Already have an account? <Link to="/login" className="login-register-link">Sign in</Link></span>
                    </div>
                </div>
            </div>

            {/* Right Panel — Visual (Exact match to Login) */}
